...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 04, 2018 at 05:37 AM
...
(2, 2000, 9, 1, 2, 1, 0, 1, '2018-09-04 03:35:49', '2018-09-04 03:36:28');
...
(2, 'admin@gmail.com', 1, 'Sergio', 'García', 'm', 'passport/rmhrjgAdn69GD2BLvG6sn5LwEZ2AnWnQZQriHDnu.jpeg', NULL, '04241844847', NULL, NULL, 'En la esquina', 'Venezuela', 'Caracas', 'Dto Capital', '1995-03-14', 'sergio', '$2y$10$vvgVRsgiKMwGxauCsVqUhe05N28JLvy7h7FhLQZn.BAPGumpofd32', '2018-09-03 21:39:40', '2018-09-03 21:41:25', 'UxRs3Kqljg9GqvsElPWBXrU5vlHxlMplIvyM6CusEgqPZEo7Px06zAA3WyVg');
...
--
ALTER TABLE `bank_account`
  MODIFY `id_bank_account` bigint(255) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `transaction`
  MODIFY `id_transaction` bigint(255) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `wallet`
  MODIFY `id_wallet` bigint(255) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
