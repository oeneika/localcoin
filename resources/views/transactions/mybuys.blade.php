...
<div id="content" class="content">
            ...
            <div class="row">
                <div class="col-md-12">
                    <button @if (count(Auth::user()->wallets) < 1) disabled @endif class="btn btn-primary" style="float:right; margin-bottom: 10px;" onclick="openModalBuy()"> Crear Compra </button>
                </div>
            </div> 
